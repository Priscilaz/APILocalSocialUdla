...
namespace UdlaBlog.WebAPI.Local.Controllers
{
    ...
    public class BlogPostsController : ControllerBase
    {
        ...
        public BlogPostsController(IBlogPostRepository repository, IWebHostEnvironment webHostEnvironment)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<BlogPostDto>> PostBlogPost([FromForm] BlogPostDto blogPostDto)
        {
            ...
            return CreatedAtAction(nameof(GetBlogPost), new { id = blogPost.Id }, ConvertToDto(blogPost));
        }

        [HttpPut("{id}")]
        public async Task<IActionResult> PutBlogPost(Guid id, [FromForm] BlogPostDto blogPostDto)
        {
        ...
        private static BlogPostDto ConvertToDto(BlogPost blogPost)
        {
            return new BlogPostDto
            {
                ...
                ImagenDestacada = null, // No se puede asignar IFormFile aquí
